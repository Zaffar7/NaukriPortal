...
import naukri.portal.service.JobSeekerApplyService;
...
@Controller
public class JobPostActivityctlr {
    ...
    @Autowired
    public JobPostActivityctlr(UsersService usersService, JobPostActivityService jobPostActivityService, JobSeekerApplyService jobSeekerApplyService, JobSeekerSaveService jobSeekerSaveService) {
    ...
    public String searchJobs(Model model,
        ...
        Object currentUserProfile = usersService.getCurrentUserprof();
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                ...
                List<JobSeekerApply> jobSeekerApplyList = jobSeekerApplyService.getCandidatesJobs((Jobseeker) currentUserProfile);
                List<JobSeekerSave> jobSeekerSaveList = jobSeekerSaveService.getCandidatesJob((Jobseeker) currentUserProfile);
